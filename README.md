...
``` bash
curl -s https://raw.githubusercontent.com/mahmoudhashemm/odoo-18-N/main/run.sh | sudo bash -s odoo-18-one 10015 20015 8069 8072 10.0.0.0/29 10.0.0.1 10.0.0.2 10.0.0.3 my-odoo-net
```
