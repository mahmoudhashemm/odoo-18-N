...
# استنساخ الريبو
git clone --depth=1 https://github.com/mahmoudhashemm/odoo-18-N.git "$DESTINATION"
...
# تنزيل enterprise
if git ls-remote git@github.com:mahmoudhashemm/odoo18pro >/dev/null 2>&1; then
  git clone --depth 1 --branch master git@github.com:mahmoudhashemm/odoo18pro "$DESTINATION/enterprise"
else
  git clone --depth 1 --branch master https://github.com/mahmoudhashemm/odoo18pro "$DESTINATION/enterprise" || true
fi
